import { ButtonSelector, Header, Toast } from "@egovernments/digit-ui-react-components";
    ...
    <div className="md:w-5/6 w-full mb-60">
      ...
      <div className="pb-4"> 
        ...
        <p className="md:text-xs lg:text-sm 2xl:text-base">
         {`<Toast label="success" /> `} Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium voluptates quaerat officiis architecto nam repudiandae veniam in ipsam, repellendus accusantium cumque nostrum id officia aliquam dolore vitae expedita adipisci animi.
        </p>
      </div>
